...
from trl.trainer.utils import truncate_with_protected_tokens, pad
...
class VAPORTrainer(GRPOTrainer):
    """
    VAPOR Trainer
    """
    ...
    def __init__(
        ...
        # Check if VAPOR necessary arguments are provided
        """
        ...
        """
        if hasattr(args, "verifiable_term_split"):
            self.verifiable_term_split = args.verifiable_term_split
        else:
            raise ValueError("verifiable_term_split is required for VAPOR")
        if hasattr(args, "preference_term_split"):
            self.preference_term_split = args.preference_term_split
        else:
            raise ValueError("preference_term_split is required for VAPOR")
        if hasattr(args, "preference_temperature"):
            self.preference_temperature = args.preference_temperature
        else:
            self.preference_temperature = 0.1
